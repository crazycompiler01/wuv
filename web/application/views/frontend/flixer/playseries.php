...
<div class="video_cover">
	<div class="container" style="padding-top:100px; text-align: center;">
		<div class="row">
			<div class="col-lg-10 col-lg-offset-1" id="series_div">
...
<div class="container" style="margin-top: 30px;">
	<div class="row">
		<div class="col-lg-10 col-lg-offset-1">
			<div class="row">
				<div class="col-lg-3">
					<img src="<?php echo $this->crud_model->get_thumb_url('series' , $row['series_id']);?>" style="width: 100%" />
				</div>
				<div class="col-lg-9">
					<!-- VIDEO TITLE -->
					<h3>
		...
		<div class="col-lg-10 col-lg-offset-1">
			...
			<button class="btn btn-primary btn-lg" id = 'watch_button' style="font-size: 16px; margin-top: 20px;" onclick="divToggle()">
