...
<div style="height:93vh;width:100%;">
	...
	<div style="float: right;margin: 18px 18px; height: 50px;" class="hidden-xs"> 
		<a href="<?php echo base_url();?>index.php?home/signin" class="btn btn-success btn-lg"><?php echo get_phrase('sign_in');?></a>
	</div>
	...
	<div style="font-size: 85px;font-weight: bold;clear: both;padding: 100px 0px 0px 0px; text-align:center; color: #fff;" class="hidden-xs">
		...
		<a href="<?php echo base_url();?>index.php?home/signup" class="btn btn-success btn-lg"
	...
	<div style="font-size: 45px;font-weight: bold;clear: both;padding: 80px 0px 0px 0px; text-align:center; color: #fff;" class="hidden-lg hidden-sm hidden-md">
		...
		<a href="<?php echo base_url();?>index.php?home/signup" class="btn btn-success btn-lg" ><?php echo get_phrase('JOIN_FREE_FOR_A_MONTH');?></a>
		<br>
		<a href="<?php echo base_url();?>index.php?home/signin" class="btn btn-success btn-lg" ><?php echo get_phrase('SIGN_IN');?></a>
	</div>
</div>
...
<div class="container wuv-sign-in-page">
	<div class="row">
		<div class="col-lg-12">
			<div class="bs-component">
				...
				<div id="myTabContent" class="tab-content">
					<div class="tab-pane active in" id="cancel">
						<p>
						<div class="row">
							<div class="col-md-7 md-content" style="padding-top: 50px;">
								<h4 style="color: #fff;">
					...
					<div class="tab-pane" id="price">
						<p>
						<div class="row md-content" style="margin: 35px;">
						...
						<div class="table-responsive">
							<table class="table table-striped table-hover" style="color: #fff; background-color: transparent;">
								<tbody>
