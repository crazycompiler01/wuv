	...
	<div class="container" style=" width: 100%;">
		...
		<div class="navbar-collapse collapse" id="navbar-main">
			<ul class="nav navbar-nav">
				<!-- MOVIES GENRE WISE-->
				<li class="dropdown">
					<a class="dropdown-toggle" data-toggle="dropdown" href="" style="color: #043174; font-weight: bold;">
						<?php echo get_phrase('Resources');?> <span class="caret"></span>
					</a>
				...
				<li class="dropdown">
					<a class="dropdown-toggle" data-toggle="dropdown" href="" style="color: #043174; font-weight: bold;">
						<?php echo get_phrase('How_to_Videos');?> <span class="caret"></span>
					</a>
					<ul class="dropdown-menu" aria-labelledby="themes">
						<?php
							$genres		=	$this->crud_model->get_genres();
				...
				<!-- MY LIST -->
				<li>
					<a href="<?php echo base_url();?>index.php?browse/mylist" style="color: #043174;"><?php echo get_phrase('My_Resources');?></a>
				</li>
			</ul>
			...
			<!-- SEARCH FORM -->
			<form class="navbar-form navbar-right search-form" method="post" action="<?php echo base_url();?>index.php?browse/search">
				<div class="form-group">
					<input type="text" class="form-control" placeholder="Resources, Type, Dreams" 
						style="background-color: white; border: 1px solid #fff; height:35px;" name="search_key">
				</div>
