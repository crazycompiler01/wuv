	...
	<div class="col-md-4 col-sm-12 ">
		<div class="card widget-flat">
			<div class="card-body">
				...
				<h5 class="text-muted font-weight-bold mt-0" title="Number of Customers"><?php echo get_phrase('total_resources'); ?></h5>
	...
	<div class="col-md-4 col-sm-12 ">
		<div class="card widget-flat">
			<div class="card-body">
				...
				<h5 class="text-muted font-weight-bold mt-0" title="Number of Customers"><?php echo get_phrase('total_how_to_videos'); ?></h5>
	...
	<div class="col-md-4 col-sm-12 ">
		<div class="card widget-flat">
			<div class="card-body">
				...
				<h5 class="text-muted font-weight-bold mt-0" title="Number of Customers"><?php echo get_phrase('total_episodes'); ?></h5>
	...
	<div class="col-md-4 col-sm-12 ">
		<div class="card widget-flat">
			<div class="card-body">
				...
				<h5 class="text-muted font-weight-bold mt-0" title="Number of Customers"><?php echo get_phrase('total_registered_user'); ?></h5>
	...
	<div class="col-md-4 col-sm-12 ">
		<div class="card widget-flat">
			<div class="card-body">
				...
				<h5 class="text-muted font-weight-bold mt-0" title="Number of Customers"><?php echo get_phrase('total_active_subscription'); ?></h5>
				<h3 class="mt-3 mb-3">
					<?php
	...
	<div class="col-md-4 col-sm-12 ">
		<div class="card widget-flat">
			<div class="card-body">
				...
				<h5 class="text-muted font-weight-bold mt-0" title="Number of Customers"><?php echo get_phrase('sales_this_month'); ?></h5>
				<h3 class="mt-3 mb-3">
					<?php
						$total_sale	=	0;
						$month			=	date("F");
