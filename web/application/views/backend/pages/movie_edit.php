	...
	<div class="row">
	        ...
	        <div class="card">
	            <div class="card-body">
					<div class="form-group mb-3">
	                    <label for="simpleinput1">Resource Title</label>
	                    <input type="text" class="form-control" id = "simpleinput1" name="title" value="<?php echo $movie_detail->title;?>">
	                </div>
					<div class="form-group mb-3">
	                    <label for="url">Resource Source Url</label>
						<span class="help">- link to resource site</span>
					...
					<div class="form-group mb-3">
						...
						<span class="help">- icon image of the resource</span>
	                    <input type="file" class="form-control" name="thumb">
	                </div>

					<div class="form-group mb-3">
	                    <label for="">Poster</label>
						<span class="help">- large banner image of the resource</span>
					...
					<div class="form-group mb-3">
						...
						<span class="help">- featured resource will be shown in home page</span>
		...
		<div class="row">
			<div class="form-group col-3">
				<input type="submit" class="btn btn-success col-12" value="Update Resource">
			</div>
			<div class="col-3">
