...
<div class="row justify-content-center">
    <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12">
        <div class="card">
            <div class="card-body">
                <h4 class="header-title">Dream List</h4>
                <table id="basic-datatable" class="table dt-responsive nowrap" width="100%">
					...
					<tbody>
						...
						<tr>
							...
							<td style="vertical-align: middle;"><a href="<?php echo base_url().'index.php?admin/actor_wise_movie_and_series/'.$row['actor_id']; ?>" style="color: #ccc;"><?php echo $row['name'];?></a></td>
