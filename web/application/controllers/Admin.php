...
class Admin extends CI_Controller {
	...
	function genre_list()
	{
		...
		$page_data['page_title']	=	'Manage Type';
		$this->load->view('backend/index', $page_data);
	}
	...
	function genre_edit($genre_id = '')
	{
		...
		$page_data['page_title']	=	'Edit Type';
		$this->load->view('backend/index', $page_data);
	}
	...
	function movie_list()
	{
		...
		$page_data['page_title']	=	'Manage Resource';
		$this->load->view('backend/index', $page_data);
	}
	...
	function movie_create()
	{
		...
		$page_data['page_title']	=	'Create Resource';
		$this->load->view('backend/index', $page_data);
	}
	...
	function movie_edit($movie_id = '')
	{
		...
		$page_data['page_title']	=	'Edit Resource';
		$this->load->view('backend/index', $page_data);
	}
	...
	function series_list()
	{
		...
		$page_data['page_title']	=	'Manage How to Videos';
		$this->load->view('backend/index', $page_data);
	}
	...
	function series_create()
	{
		...
		$page_data['page_title']	=	'Create How to Videos';
		$this->load->view('backend/index', $page_data);
	}
	...
	function series_edit($series_id = '')
	{
		...
		$page_data['page_title']	=	'Edit How to Videos';
		$this->load->view('backend/index', $page_data);
	}
	...
	function actor_list()
	{
		...
		$page_data['page_title']	=	'Manage Dream';
		$this->load->view('backend/index', $page_data);
	}
	...
	function actor_create()
	{
		...
		$page_data['page_title']	=	'Create Dream';
		$this->load->view('backend/index', $page_data);
	}
	...
	function actor_edit($actor_id = '')
	{
		...
		$page_data['page_title']	=	'Edit Dream';
		$this->load->view('backend/index', $page_data);
	}
	...
	function actor_wise_movie_and_series($actor_id) {
		...
		$page_data['page_name']				=	'dream_wise_movie_and_series';
		$page_data['page_title']			=	get_phrase('resources_and_TV_series_of').' "'.$actor_details['name'].'"';
		$page_data['actor_id']				=	$actor_id;
